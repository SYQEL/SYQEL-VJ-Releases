...
To run the SYQEL VJ app on MacOS first download [SYQEL.dmg](https://github.com/SYQEL/SYQEL-VJ-Releases/releases/download/v2.3.3/SYQEL.VJ.MAC.dmg) installer
Then install the application.
